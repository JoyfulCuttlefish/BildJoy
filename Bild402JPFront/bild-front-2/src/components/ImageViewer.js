  ...
  return (
    <div>
      ...
      <div className='stage-container'>
        <Stage width={900} height={600} className='stage'>
          <Layer>
            {shapes &&
      ...
      <div>
        ...
        {/* <button type="button" id="PUT" onClick={updateImage}>Modify Image (patch)</button> */}
        <button type="button" id="DELETE" onClick={removeImage}>Delete Image</button>
